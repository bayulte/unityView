...
IL_0036:
	{
		...
		V_3 = ((*(int32_t*)UnBox(L_9, il2cpp_defaults.int32_class)));
		goto IL_0044;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RuntimeObject* AsyncWriteDelegate_BeginInvoke_m6BFE27A81614BA95217F16ABF61B3C60F8C19031 (AsyncWriteDelegate_t460790C3F94609B4F2D9F7FB2B5CF541A8D5B18E* __this, ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* ___0_array, int32_t ___1_offset, int32_t ___2_count, bool ___3_isAsync, AsyncCallback_t7FEF460CBDCFB9C5FA2EF776984778B9A4145F4C* ___4_callback, RuntimeObject* ___5_object, const RuntimeMethod* method) 
{
	...
	__d_args[3] = Box(il2cpp_defaults.boolean_class, &___3_isAsync);
...
IL_0091:
	{
		...
		V_4 = ((int64_t)il2cpp_codegen_subtract(((int64_t)(uint64_t)((uint32_t)L_21)), ((int64_t)((int32_t)8192))));
		int64_t L_22 = V_4;
...
IL_0011:
	{
		...
		L_5 = FastEncoderWindow_RecalculateHash_m95CACEC8E86D17EC3BAA6F7207C8485C67539720(__this, L_4, NULL);
		int32_t L_6 = V_0;
		Debug_Assert_m6B8BE1380B220153ED4E4A0A2E087FCAE503BB37((bool)((((int64_t)((int64_t)(uint64_t)((uint32_t)L_5))) == ((int64_t)((int64_t)L_6)))? 1 : 0), _stringLiteralA772D2D655EFD5780BE5B0CC76ECC49947AA2D43, NULL);
...
IL_0027:
	{
		...
		V_1 = (bool)((((int32_t)((((int64_t)L_5) == ((int64_t)((int64_t)(uint64_t)((uint32_t)L_6))))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		bool L_7 = V_1;
		if (!L_7)
		{
			goto IL_004e;
...
IL_012a:
	...
	}
	{
		...
		int16_t L_53 = V_1;
		NullCheck(L_51);
		(L_51)->SetAt(static_cast<il2cpp_array_size_t>(L_52), (int16_t)((int16_t)((-((int32_t)L_53)))));
		int16_t L_54 = V_1;
		V_16 = ((int16_t)((-((int32_t)L_54))));
		int16_t L_55 = V_1;
...
IL_001e:
	{
		...
		if ((int64_t)(((int64_t)(((int64_t)(uint64_t)((uint32_t)L_6))&((int64_t)L_7)))) > INTPTR_MAX) IL2CPP_RAISE_MANAGED_EXCEPTION(il2cpp_codegen_get_overflow_exception(), HuffmanTree_GetNextSymbol_m0963B6501A1F8E1F03296582F05F7E48354F1447_RuntimeMethod_var);
		NullCheck(L_5);
		intptr_t L_8 = ((intptr_t)((int64_t)(((int64_t)(uint64_t)((uint32_t)L_6))&((int64_t)L_7))));
